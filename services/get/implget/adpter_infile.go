...
func NewInFileAdapter(repository nfe.Repository) get.GetGateway {
	return &inFileAdapter{
		repository: repository,
	}
}

func (adapter *inFileAdapter) Processor(request get.Request) (get.Response, error) {
...
func (adapter *inFileAdapter) receiver(request get.Request) (nfe.NfeDocument, error) {
...
func (adapter *inFileAdapter) responder(nfeDocument nfe.NfeDocument) get.Response {
	return get.Response{
